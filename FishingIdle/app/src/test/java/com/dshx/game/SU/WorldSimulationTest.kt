...
import com.dshx.game.SU.game.BoatArt
import com.dshx.game.SU.game.BobberState
import com.dshx.game.SU.game.Chest
import com.dshx.game.SU.game.Content
import com.dshx.game.SU.game.Diver
import com.dshx.game.SU.game.Fish
import com.dshx.game.SU.game.Rarity
import com.dshx.game.SU.game.FishState
import com.dshx.game.SU.game.GameState
import com.dshx.game.SU.game.Source
import com.dshx.game.SU.game.Space
...
class WorldSimulationTest {
    ...
    fun `钓手会自动钓鱼并产出金币`() {
        ...
        // 要看钓手这个来源实际产出了多少。
        val helperEarned = state.earningsBySource[com.dshx.game.SU.game.Source.HELPER] ?: 0.0
    ...
    fun `钓手数量多于鱼时不会产生额外收益也不会崩溃`() {
        ...
        // 但收益仍然要正常产生
        assertTrue((state.earningsBySource[com.dshx.game.SU.game.Source.HELPER] ?: 0.0) > 0.0)
    }
    ...
    fun `连锁反应会一次结算多条鱼`() {
        ...
        val chainEarned = state.earningsBySource[com.dshx.game.SU.game.Source.CHAIN] ?: 0.0
