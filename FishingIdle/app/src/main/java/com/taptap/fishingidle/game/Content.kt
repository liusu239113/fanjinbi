...
object Content {
    ...
    val upgrades: List<PurchasableDef> = listOf(
        ...
        PurchasableDef(
            ...
            icon = "icon_value", priceBase = 1.8, priceMultiplier = 40.0,
        ...
        PurchasableDef(
            ...
            icon = "icon_value", priceBase = 1.8, priceMultiplier = 200.0,
        ...
        PurchasableDef(
            ...
            icon = "icon_value", priceBase = 1.8, priceMultiplier = 800.0,
        ...
        PurchasableDef(
            ...
            icon = "icon_value", priceBase = 1.8, priceMultiplier = 12000.0,
        ...
        PurchasableDef(
            ...
            icon = "icon_multiplier", priceBase = 1.9, priceMultiplier = 30.0,
        ...
        PurchasableDef(
            ...
            icon = "icon_multiplier", priceBase = 1.9, priceMultiplier = 150.0,
            increaseAmount = 0.2, maxPurchases = 20,
        ...
        PurchasableDef(
            ...
            icon = "icon_multiplier", priceBase = 1.9, priceMultiplier = 600.0,
            increaseAmount = 0.2, maxPurchases = 20,
        ...
        PurchasableDef(
            ...
            icon = "icon_multiplier", priceBase = 1.9, priceMultiplier = 9000.0,
            increaseAmount = 0.2, maxPurchases = 20,
        ...
        PurchasableDef(
            ...
            icon = "icon_speed", priceBase = 1.5, priceMultiplier = 500.0,
        ...
        PurchasableDef(
            ...
            icon = "icon_speed", priceBase = 1.5, priceMultiplier = 1500.0,
        ...
        PurchasableDef(
            ...
            icon = "icon_speed", priceBase = 1.5, priceMultiplier = 4000.0,
            increaseAmount = 0.2, maxPurchases = 20,
            visibleWhen = { it.epicFish >= 5 },
        ),
        PurchasableDef(
            ...
            icon = "icon_speed", priceBase = 1.5, priceMultiplier = 60000.0,
            increaseAmount = 0.2, maxPurchases = 20,
            visibleWhen = { it.legendFish >= 5 },
        ),
        ...
        PurchasableDef(
            ...
            icon = "icon_helper", priceBase = 1.9, priceMultiplier = 30.0,
            increaseAmount = 0.15, maxPurchases = 20,
    ...
    /** 全部购买项，顺序即重放顺序。 */
    val purchasables: List<PurchasableDef> = fishItems + upgrades
