...
object Content {
    ...
    val lateGame: List<PurchasableDef> = listOf(
        PurchasableDef(
            ...
            icon = "icon_pelican", priceBase = 0.0, priceMultiplier = 0.0, flatOffset = 250_000.0,
            maxPurchases = 1,
            visibleWhen = { it.helpers >= 4 && it.totalCatches >= 120 },
        ),
        PurchasableDef(
            id = "net_sweep", attribute = Attribute.NET_SWEEP,
            name = "拖网",
            desc = "每 45 秒自动撒一次网，把船附近最多 $NET_MAX_FISH 条鱼一起捞上来。",
            icon = "icon_net", priceBase = 0.0, priceMultiplier = 0.0, flatOffset = 600_000.0,
            maxPurchases = 1,
            visibleWhen = { it.helpers >= 6 && it.totalCatches >= 220 },
        ),
    )
    ...
    val lateGame2: List<PurchasableDef> = listOf(
        PurchasableDef(
            ...
            icon = "icon_sonar", priceBase = 0.0, priceMultiplier = 0.0, flatOffset = 1_200_000.0,
            maxPurchases = 1,
        ...
        PurchasableDef(
            ...
            icon = "icon_finder", priceBase = 0.0, priceMultiplier = 0.0, flatOffset = 2_000_000.0,
            maxPurchases = 1,
        ...
        PurchasableDef(
            ...
            icon = "icon_drone", priceBase = 0.0, priceMultiplier = 0.0, flatOffset = 3_500_000.0,
            maxPurchases = 1,
        ...
        PurchasableDef(
            ...
            icon = "icon_diver", priceBase = 0.0, priceMultiplier = 0.0, flatOffset = 6_000_000.0,
            maxPurchases = 1,
        ...
        PurchasableDef(
            ...
            icon = "icon_chest", priceBase = 0.0, priceMultiplier = 0.0, flatOffset = 10_000_000.0,
            maxPurchases = 1,
